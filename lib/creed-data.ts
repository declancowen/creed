...
export function buildAgentReadPayload(
  ...
  return [
    ...
    "- `creed_list_document_comments`, `creed_create_document_comment`, `creed_create_proposal_comment`, and `creed_reply_to_document_comment` for pending user-approval comments on document content or proposal diffs.",
    ...
    "- You may read proposals created by the user and by others, and may add pending user-approval comments/replies to either document content or a specific proposal diff. Use `creed_create_document_comment` for document content and `creed_create_proposal_comment` for proposal diffs.",
